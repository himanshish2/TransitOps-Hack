  ...
  return (
    <header className="transitops-topnavbar">
      ...
      <div className="ms-auto d-flex align-items-center gap-md">
        ...
        <button type="button" className="btn-icon position-relative" aria-label="Notifications">
          <FiBell size={16} />
          ...
          {isDropdownOpen && (
            <div className="dropdown-menu show profile-dropdown-menu">
              <div className="dropdown-item-text">
                ...
                <div className="text-muted-custom" style={{ fontSize: 'var(--font-size-xs)' }}>{user?.email}</div>
              </div>
              <div className="dropdown-divider" />
              <button type="button" className="dropdown-item d-flex align-items-center gap-sm" onClick={handleLogout}>
